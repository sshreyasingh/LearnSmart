    ...
    <div className="page-container">
      ...
      {!hasProjects ? (
        ...
        <div className="space-y-8">
          <StaggerChildren animation="fadeUp" baseDelay={80} className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <StaggerChildren animation="fadeUp" baseDelay={100} className="grid gap-4">
