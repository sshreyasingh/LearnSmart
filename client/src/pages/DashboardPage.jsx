    ...
    <div className="card-white p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-5 group">
      <div className="min-w-0 flex-1">
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white shrink-0 mt-0.5 shadow-sm">
      ...
      <div className="flex items-center gap-2.5 shrink-0 ml-[52px] sm:ml-0">
