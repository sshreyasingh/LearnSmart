    ...
    <div className="space-y-5">
          ...
          <ul className="space-y-2">
            {data.keyFeatures.map((f, i) => (
              <li key={i} className="flex items-start gap-3 text-sm text-surface-600">
                <span className="w-5 h-5 bg-primary-100 text-primary-600 rounded-md flex items-center justify-center shrink-0 mt-px">
      ...
      {data.uniqueValue && (
        <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl">
          <h3 className="text-xs font-bold text-amber-800 uppercase tracking-widest mb-1">Unique Value</h3>
    ...
    <div className="section-card">
      ...
      <div className="mt-6 pt-6 border-t border-emerald-200/60">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-white/70 rounded-xl p-4 text-center border border-surface-100">
        ...
        <div className="mt-6 pt-6 border-t border-emerald-200/60">
          ...
          <div className="flex flex-wrap gap-2">
            {techStack.map((tech) => (
              <span
                key={tech}
                className="px-3 py-1.5 bg-primary-50 text-primary-700 rounded-lg text-xs font-semibold border border-primary-100"
              >
                {tech}
              </span>
            ))}
