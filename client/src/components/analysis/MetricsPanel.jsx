function StatCard({ icon, label, value, sub, color = 'primary' }) {
  const colorMap = {
    primary: 'bg-blue-900/15 text-blue-400',
    green: 'bg-emerald-900/15 text-emerald-400',
    yellow: 'bg-yellow-50 text-yellow-700',
    red: 'bg-red-900/15 text-red-400',
    purple: 'bg-purple-900/20 text-purple-400',
  };
  const bg = colorMap[color] || colorMap.primary;

  return (
    <div className="bg-surface-100 border border-surface-300 rounded-lg p-4 text-center">
...
export function MetricsPanel({ metrics }) {
  ...
  return (
    <div className="bg-surface-100 rounded-xl shadow-sm border border-surface-300 p-6 mt-6">
      <h2 className="text-xl font-bold text-surface-800 mb-4">Code Metrics</h2>
