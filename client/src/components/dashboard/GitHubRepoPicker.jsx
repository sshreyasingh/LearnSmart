    ...
    <div className="grid gap-3 max-h-96 overflow-y-auto scrollbar-thin pr-1">
      {selected.map((repo) => (
        <button
          ...
          className="text-left p-4 bg-surface-100 border border-surface-200 rounded-xl hover:border-primary-300 hover:shadow-soft transition-all duration-200 group"
        >
          <div className="flex items-center justify-between">
            <span className="font-semibold text-surface-900 group-hover:text-primary-400 transition-colors">{repo.name}</span>
